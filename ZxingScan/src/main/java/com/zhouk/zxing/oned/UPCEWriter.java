...
import com.zhouk.zxing.oned.UPCEANWriter;
  ...
  public boolean[] encode(String contents) {
    ...
    switch (length) {
      case 7:
        ...
        int check;
        try {
          check = UPCEANReader.getStandardUPCEANChecksum(com.zhouk.zxing.oned.UPCEReader.convertUPCEtoUPCA(contents));
      ...
      case 8:
        try {
          if (!UPCEANReader.checkStandardUPCEANChecksum(com.zhouk.zxing.oned.UPCEReader.convertUPCEtoUPCA(contents))) {
