...
import com.zhouk.zxing.oned.Code39Reader;
import com.zhouk.zxing.oned.OneDimensionalCodeWriter;
import com.zhouk.zxing.BarcodeFormat;
...
public final class Code39Writer extends OneDimensionalCodeWriter {
  ...
  public boolean[] encode(String contents) {
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = com.zhouk.zxing.oned.Code39Reader.ALPHABET_STRING.indexOf(contents.charAt(i));
      if (indexInString < 0) {
    ...
    toIntArray(com.zhouk.zxing.oned.Code39Reader.ASTERISK_ENCODING, widths);
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = com.zhouk.zxing.oned.Code39Reader.ALPHABET_STRING.indexOf(contents.charAt(i));
      toIntArray(com.zhouk.zxing.oned.Code39Reader.CHARACTER_ENCODINGS[indexInString], widths);
