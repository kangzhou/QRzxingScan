...
public abstract class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void handleResult(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        setResult(rawResult, barcode, scaleFactor);
    }
     ...
     * @param scaleFactor
     */
    protected abstract void setResult(Result rawResult, Bitmap barcode, float scaleFactor);
...
//            Log.w(TAG, "重复打开");
     ...
     * 重新扫码
     */
    public void continuousScan(long delayMS) {
        if (handler != null) {
            if (delayMS < 0) {
                delayMS = 0L;
            }
